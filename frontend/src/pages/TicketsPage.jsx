    ...
    <div>
      ...
      {loading ? (
        ...
        <div className="space-y-3">
          {incidents.map((inc) => (
            <div key={inc.id} className="border-2 border-zinc-900 p-4 bg-white">
              ...
              {isAdmin && inc.status !== "RESOLVED" && (
                <div className="mt-3 flex gap-2">
                  <select
                    className="flex-1 border border-zinc-900 font-mono text-xs px-2 py-1 focus:outline-zinc-500"
                  ...
                  <button
                    ...
                    className="font-mono text-xs uppercase tracking-widest border-2 border-zinc-900 px-3 py-1 hover:bg-zinc-900 hover:text-white transition-colors text-zinc-900"
                  >
                    Assign
                  </button>
                </div>
